...
public class TestDatabaseConfig
{
    ...
    public TestDatabaseConfig(@Value("${spring.datasource.url}") String serverUrl,
                              ...
                              @Value("${spring.datasource.testdb:easyshop_test}") String testDb)
    {
    ...
    public void setup() {
        ...
        try(Connection connection = DriverManager.getConnection(serverUrl.replace("/easyshop", "") + "/sys", username, password);
    ...
    public DataSource dataSource() throws SQLException, IOException
    {
        ...
        dataSource.setUrl(String.format("%s/%s", serverUrl.replace("/easyshop", ""), testDb));
